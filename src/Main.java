...
//    }
    ...
    public static int searchNumber1(int[] n) {
        ...
        for (int i = 0; i < counts.length; i++) {
            if (counts[i] < minCounts && counts[i] != 0) {
                minCounts = counts[i];
                number = i-100;
            }
        }
...
//        System.out.println("Первый элемент с наименьшим количеством вхождений: " + searchNumber(n));
        ...
        int[] n1 = new int[]{-99, -85, -99, -85, 0, 3, 5, 5, 3, 12, 0, 12, 19, 19, 35, 35, 80, 35, 80, 11, 98, 98, 99, 99, -1};
        int[] n2 = new int[]{-99, -99, 100, 100, 99, 1, 1, 1, -1};
        System.out.println("Первый элемент с наименьшим количеством вхождений: " + searchNumber1(n1));
        System.out.println("Первый элемент с наименьшим количеством вхождений: " + searchNumber1(n2));
    }
}
